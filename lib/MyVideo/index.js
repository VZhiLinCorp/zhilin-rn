                ...
                this.state.isPlaying ? null :
                  <TouchableWithoutFeedback onPress={() => { this.onPressPlayButton() }}>
                    <Image
                      ...
                      source={require('./icon_video_play.png')}
                    />
              ...
              <View style={[styles.control, {width: this.state.videoWidth}]}>
                <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlPlayPress() }}>
                  <Image
                    ...
                    source={this.state.isPlaying ? require('./icon_control_pause.png') : require('./icon_control_play.png')}
                  />
                </TouchableOpacity>
                ...
                <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlShrinkPress() }}>
                  <Image
                    ...
                    source={this.state.isFullScreen ? require('./icon_control_shrink_screen.png') : require('./icon_control_full_screen.png')}
                  />
                </TouchableOpacity>
              </View> : null
          }
